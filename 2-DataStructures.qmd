...
> In line 62 the vector is only using five numbers out of the seven. So logically the output if "true" or "false", not returning what was in the original vector. In line 67, I believe that it is saying that "x" is less than 7 which represents the overall numbers in the vector. fhgkjdfgjfd
