...
> In this dataset (it's loading as a csv. not too sure why) but I chose to subset the first ten rows of data, which showed 4 different categories. The result shows the first 10 individuals, their name, race, owner, and their motive which I think is a critical category to have. 
