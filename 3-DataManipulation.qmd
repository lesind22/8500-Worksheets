...
> In order to save it to another data frame, I had to create a new data frme using the existing data from gay guides. Then I had to use the selet() function to only extract city and state from the data. 
