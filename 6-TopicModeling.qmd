...
MB.topics %>%
  ...
  scale_y_reordered()
```
It changes the model to have only the top words for the periodical accounting for the custom stopword list that was created. (There was a bar graph, not sure where it disappeared to.)
